...
import { ScrollTrigger } from "gsap/ScrollTrigger"; import ThreeLogo from './3dLogo.js';
...
const LandingPage = () => {
    ...
    const contactButtonAppear = gsap.timeline({ paused: true });
    ...
    useEffect(() => {
        ...
        ScrollTrigger.matchMedia({
            ...
            "(min-width: 860px)": function () {
                ...
                gsap.from(brandName.current, {
                    opacity: 0,
                    duration: .5,
                })
             
                gsap.from(homeFooter.current, {
                    delay: .5 ,
                    opacity: 0,
                    y: 20
                })
                ...
                contactButtonAppear
                    .to(plusSign.current, { rotate: 180 })
                    .to(contactLink.current, { x: 0 })
    ...
    return (
        <div className="home">
            <section className="home-1 wrapper">
                ...
                <div className="brand-name" ref={brandName}>
                    <svg className="brand-name-desktop" width="900" height="470" viewBox="0 0 1217 470" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="home-1-footer" ref={homeFooter}>
                    <h3>CREATIVE DIGITAL SERVICES</h3>
                    <div className="contact-button-container">
                        <div className="contact-link-wrap">
                            <div className="contact-link" ref={contactLink}>
                                <a href="mailto:billyberkouwer@live.co.uk">CONTACT</a>
                            </div>
                        </div>
                        <button ref={plusSign} onClick={() => contactButtonAppear.play()}>+</button>
                    </div>
            ...
            <section className="home-2 wrapper">
                ...
                <div className="info-container-1-desktop">
                    <p>
                        <div ref={infoLine1}> <div class="paragraph-arrow">
                            <svg width="70" height="23" viewBox="0 0 105 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <line y1="-1.5" x2="97.9996" y2="-1.5" transform="matrix(1 2.10493e-05 -4.13903e-05 1 0.162415 6.99609)" stroke="black" stroke-width="3" />
                                <rect x="93.0584" y="0.043335" width="11" height="11" fill="black" />
                            </svg>
